...
字节的 Android PLT hook 方案 ByteHook 开源了。ByteHook 支持 Android 4.1 - 12 (API level 16 - 31)，支持 armeabi-v7a, arm64-v8a, x86 和 x86_64，使用 MIT 许可证授权。

字节的大多数 Android App 都在线上使用了 ByteHook 作为 PLT hook 方案。字节内部有 20 多个不同技术纬度的 SDK 使用了 ByteHook。ByteHook 在线上稳定性，功能性，性能等多个方面都达到了预期。

GitHub 地址：https://github.com/bytedance/bhook
...
![](img/2021-08-19-linker-reloc.png)
...
![](img/2021-08-19-linker-reloc-call.png)

relocation 完成之后的数据引用关系如下：

![](img/2021-08-19-linker-reloc-ref.png)
...
![](img/2021-08-19-bytehook-intro.png)
...
![](img/2021-08-19-unhook-without-trampoline.png)
...
![](img/2021-08-19-unhook-with-trampoline.png)
